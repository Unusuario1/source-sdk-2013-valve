...
float		g_fUnitSphereVectorVertexInnerAngle; // Internal value generated by GenerateUnitSphereLookUpTable, dont touch it!
...
void VRAD_LoadBSP( char const *pFilename )
{
	...
	GenerateUnitSphereLookUpTable(g_bDumpGeneratedUnitSphereVectors, source, g_iUnitSpherePoints, g_fUnitSphereVectorVertexInnerAngle);
	ParseEntities ();
...
void PrintUsage( int argc, char **argv )
{
	...
	Warning(	
		...
		"								(Default: 162. Values above 1024 will make VRAD much slower! By default VRAD will use the old look up table, unless this command is added to the command line.)\n"
